package com.algorithms.demo.graph.dijkstra;

/*
 * Ref: http://www.dreamincode.net/forums/topic/386358-dijkstras-algorithm/
 */
import java.util.*;
...
public class Dijkstra {
	...
	/**
	 * 
	 * This constructor initializes this Dijkstra object and executes Dijkstra's algorithm
	 * on the graph given the specified initialVertexLabel. After the algorithm
	 * terminates, the shortest a-b paths and the corresponding distances will be
	 * available for all vertices b in the graph.
	 *
	 * @param graph The Graph to traverse
	 * @param initialVertexLabel The starting Vertex label
	 * @throws IllegalArgumentException If the specified initial vertex is not in the
	 * Graph
	 */
	public Dijkstra(Graph graph, String initialVertexLabel) {
		...
		if (!vertexKeys.contains(initialVertexLabel)) {
			throw new IllegalArgumentException(
					"The graph must contain the initial vertex.");
		}
		...
		this.availableVertices = new PriorityQueue<Vertex>(vertexKeys.size(),
	...
	/**
	 * This method applies Dijkstra's algorithm to the graph using the Vertex specified by
	 * initialVertexLabel as the starting point.
	 *
	 * @post The shortest a-b paths as specified by Dijkstra's algorithm and their
	...
	/**
	 *
	 * @param destinationLabel The Vertex whose shortest path from the initial Vertex is
	 * desired
	 * @return LinkedList<Vertex> A sequence of Vertex objects starting at the initial
	 * Vertex and terminating at the Vertex specified by destinationLabel. The path is the
	 * shortest path specified by Dijkstra's algorithm.
	 */
	...
	/**
	 *
	 * @param destinationLabel The Vertex to determine the distance from the initial
	 * Vertex
