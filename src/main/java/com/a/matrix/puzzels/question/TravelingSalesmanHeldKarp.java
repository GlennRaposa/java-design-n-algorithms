...
/* we need get every permutation for the provided sequenece of vertexes with their weight. 
   save permutation values in a hashMap
   have an index class that keeps Index and setOFVertieces
   Index (currentVertex, SetOfVertexes)
*/
...
public class TravelingSalesmanHeldKarp {
	   private static int INFINITY = 100000000;
	    ...
	    public static void main(String args[]){
	    	...
	    	System.out.println(5 == tshk.minCost(dist));
	    }
}
